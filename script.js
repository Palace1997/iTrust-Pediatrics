...
if(!document.getElementById('hbStack')) return;
  ...
  var PAGES=[
    ...
    '<div class="pg"><div class="kicker"><span class="d"></span>Why it matters</div><h3>Mental health is part of growing up.</h3><p class="quote">&ldquo;Anxiety, low mood, and attention struggles are as real as any fever, and the right support early can shape the years ahead.&rdquo;</p><span class="num">9</span></div>',
